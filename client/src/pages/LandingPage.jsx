...
const FEATURES = [
  { icon: <FiZap />, title: 'Personalized Journey', desc: 'AI creates YOUR unique voting roadmap based on your profile and location.', gradient: 'from-primary to-primary-dark' },
  { icon: <FiCheckCircle />, title: 'Smart Checklist', desc: 'Track every step — from registration to election day with readiness scores.', gradient: 'from-secondary to-secondary-glow' },
  { icon: <FiCpu />, title: 'Gemini AI Chat', desc: 'Get instant answers in English or Hindi, powered by Google Gemini.', gradient: 'from-accent to-accent-glow' },
  { icon: <FiShield />, title: 'Neutral & Official', desc: 'Based entirely on ECI processes — zero political bias, 100% factual.', gradient: 'from-primary via-white to-secondary' },
  { icon: <FiMapPin />, title: 'Booth Finder', desc: 'Locate your polling station, know what to carry, and booth timings.', gradient: 'from-primary-glow to-primary' },
  { icon: <FiMap />, title: 'India ECI Map', desc: 'Explore state-wise election data, voter statistics, and constituency info.', gradient: 'from-secondary-glow to-secondary' },
];
...
const TESTIMONIALS = [
  { name: 'Priya S.', location: 'Mumbai, MH', text: 'First time voter and I had no idea where to start. JanVote made everything so clear — from getting my voter ID to finding my booth!', rating: 5 },
    ...
    <div className="min-h-screen bg-bg-dark relative overflow-x-hidden">
      ...
      <header className="sticky top-0 z-40 bg-bg-card/80 backdrop-blur-xl border-b border-border/50 shadow-sm">
        <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-base font-bold gradient-text">JanVote</span>
      ...
      <section className="relative z-10 border-y border-border/50 bg-bg-card/50 backdrop-blur-sm overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-40%] right-[-10%] w-[350px] h-[350px] rounded-full blur-[100px]"
          ...
          <div className="absolute bottom-[-40%] right-[15%] w-[350px] h-[350px] rounded-full blur-[100px]"
      ...
      <section className="relative z-10 px-5 py-20">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-text-muted text-sm mt-2 max-w-lg mx-auto">From registration status to booth location — JanVote covers your entire voting journey</p>
          </motion.div>
      ...
      <footer className="relative z-10 border-t border-border/50 bg-bg-card/50">
        <div className="max-w-6xl mx-auto px-5 py-10">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-bold gradient-text">JanVote</span>
              </div>
          ...
          <div className="border-t border-border/50 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-[10px] text-text-muted">© 2025 JanVote — Not affiliated with Election Commission of India. For educational purposes.</p>
