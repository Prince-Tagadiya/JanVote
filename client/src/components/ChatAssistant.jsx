    ...
    const load = async () => {
      try {
        ...
        if (data.success && data.data.length > 0) {
          ...
          setMessages([{
            role: 'assistant',
            content: `Namaste ${user.name}! 🙏 I'm your JanVote assistant. I'm here to help you with anything related to voting in India.\n\nYou can ask me things like:\n• "How do I register as a voter?"\n• "What documents do I need?"\n• "Where is my polling booth?"\n• "Mujhe vote dene ke liye kya karna hoga?"\n\nWhat would you like to know?`,
          }]);
        }
      } catch (e) {
        setMessages([{
          role: 'assistant',
          content: `Hi ${user.name}! 👋 I'm your JanVote assistant. Ask me anything about the Indian voting process!`,
        }]);
      }
    };
    if (user) load();
