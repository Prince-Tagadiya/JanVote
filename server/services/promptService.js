...
const SYSTEM_PROMPT = `You are JanVote, a friendly and helpful election assistant for Indian voters.
...
"🙏 Namaste ${user.name}! Welcome to JanVote — your personal Indian election assistant.
